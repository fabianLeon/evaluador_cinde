...
INSERT INTO `evaluacion_respuesta` VALUES ('10',2,'Completamente de acuerdo',2,1,NULL),('10 ',2,'De acuerdo',2,1,NULL),('10',2,'En desacuerdo',2,1,NULL),('10',2,'Grupo Reflexivo',1,1,NULL),('10',2,'Ni de acuerdo ni en desacuerdo',2,1,NULL),('10',2,'OPCION A',4,1,NULL),('10',2,'OPCION B',4,1,NULL),('2015288054',103,'Grupo Reflexivo',1,1,'LIKE'),('2015288054',103,'Meller',1,1,'LIKE'),('2015288054',103,'Ni de acuerdo ni en desacuerdo',2,1,'SELECT'),('2015288054',103,'OPCION A',4,1,'SELECT'),('2015288054',103,'respuesta abierta',3,1,'LIKE');
